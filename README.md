...
| **Progressive disclosure** | Ships a [skill file](.agents/skills/interacting-with-flutter-apps/SKILL.md) -- agent loads best practices on demand, not upfront | All tools exposed at once |
